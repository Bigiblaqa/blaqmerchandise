...
$sql = "SELECT * FROM items WHERE category = 'trousers'";
...
<html>
<head>
    <title>Trousers - BlaqMerch</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>

<h1>👖 BlaqMerch - Trousers</h1>
...
<div class="grid">
    <?php if ($result && $result->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
    <?php else: ?>
        <p style="text-align:center;">No trousers in stock right now.</p>
    <?php endif; ?>
</div>
